...
![](/assets/img/2025-12-22-16-16-49.png)  
x轴表示时间轴，y轴表示响应时间  
...
# 3.线程按持续时间执行，持续10s
1. 使用同步定时器_测试持续10s
   ![](/assets/img/2025-12-22-16-51-36.png)  
   图jmeter运行中的图  
   ![](/assets/img/2025-12-22-16-51-57.png)      
2. 不使用同步定时器_测试持续10s
   ![](/assets/img/2025-12-22-16-52-21.png)  
   图 jmeter运行中的图  
   ![](/assets/img/2025-12-22-16-52-44.png)     
3. 同步定时器10线程5，持续10s
   ![](/assets/img/2025-12-22-16-48-44.png)  
   ![](/assets/img/2025-12-22-16-48-57.png)  
   时间间隔统计10ms  
   ![](/assets/img/2025-12-22-16-49-27.png)  
   时间间隔统计1ms  
   ![](/assets/img/2025-12-22-16-53-05.png)  
   同步定时器数大于线程数，持续10s，只在2025-06-27 06:51:31.476执行了一次5线程并发     
4. 同步定时器5线程10，持续10s
   ![](/assets/img/2025-12-22-16-54-13.png)  
   时间间隔统计10ms  
   ![](/assets/img/2025-12-22-16-54-33.png)  
   时间间隔统计1ms  
